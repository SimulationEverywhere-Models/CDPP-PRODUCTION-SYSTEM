...
LDFLAGS += -L.
#^|
EXAMPLESOBJS=  production.o productionBuffer.o register.o rmSource.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
production.o: /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/production.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
productionBuffer.o: /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/productionBuffer.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
rmSource.o: /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/rmSource.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${EXTRA_INCLUDES} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
production.o: \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/production.cpp \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/production.h \
...
productionBuffer.o: \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/productionBuffer.cpp \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/productionBuffer.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/port.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/ltranadm.h
register.o: \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/register.cpp \
 ...
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/portlist.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/model.h \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/rmSource.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/atomic.h \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/productionBuffer.h \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/production.h
rmSource.o: \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/rmSource.cpp \
 /cygdrive/C/eclipse/CD++Builder\ Example\ Workspace/ProductionSystem-DEVS/rmSource.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/model.h \
 /cygdrive/C/eclipse/plugins/cdBuilder.simulator_1.0.0.201010092241/internal/port.h \
